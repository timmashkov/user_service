...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "login", sa.String(), nullable=False, comment="Логин пользователя"
        ),
        sa.Column(
            "password",
            sa.Text(),
        ...
        sa.Column(
            "email", sa.String(), nullable=False, comment="Email пользователя"
        ),
        sa.Column(
            "age", sa.Integer(), nullable=False, comment="Возраст пользователя"
        ),
        sa.Column(
            "phone_number",
            sa.String(),
